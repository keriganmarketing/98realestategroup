...
<head>
    ...
    <style>
        * { font-family: sans-serif; }
        h2 { color: #562729; font-weight:bold; }
...
<body bgcolor="#e3e0d3" style="background-color:#e3e0d3;">
<table
    cellpadding="0"
    cellspacing="0"
    border="0"
    ...
    <tbody>
    <tr>
        <td style="padding:20px; border:1px solid #ddd; border-top:10px solid #562729; border-bottom: 0;" >
            <h2>{headline}</h2>
            <p>{introcopy}</p>
    ...
    <tr>
        <td style="border-bottom: #c50a2c solid 2px; border-left:1px solid #ddd; border-right:1px solid #ddd; padding:10px;">
