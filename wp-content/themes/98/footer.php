	...
	<div id="bot-bot">
		<div class="container no-gutter">
			<div class="row">
				...
				<div class="col-xs-4 col-sm-4">
					<div class="site-info text-xs-center">
						<p class="siteby pull-sm-right"><svg version="1.1" id="kma" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 12.5 8.7" style="enable-background:new 0 0 12.5 8.7;" xml:space="preserve">
