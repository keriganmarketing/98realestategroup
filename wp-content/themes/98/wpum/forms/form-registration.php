...
<div class="wpum-template wpum-form wpum-registration-form">
	...
	<div class="row">
		...
		<?php foreach ( $data->fields as $key => $field ) : ?>
			<div class="col-md-6 <?php echo ($field['primary_id'] == 'user_firstname' || $field['primary_id'] == 'user_lastname' || $field['primary_id'] == 'user_email' ? 'col-lg-4' : ''); ?>">
			<fieldset class="fieldset-<?php echo esc_attr( $key ); ?>">
				...
				<?php else : ?>
					...
					<div class="form-group <?php echo $field['required'] ? 'required-field' : ''; ?>">
						<?php
							// Add the key to field.
							$field[ 'key' ] = $key;
							WPUM()->templates
		...
		<input type="submit" name="submit_registration" class="button btn btn-primary" value="<?php esc_html_e( 'Register', 'wp-user-manager' ); ?>" />
