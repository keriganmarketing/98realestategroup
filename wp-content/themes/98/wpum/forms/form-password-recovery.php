...
<div class="wpum-template wpum-form wpum-password-recovery-form">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<label class="hidden-sm-down" style="margin-bottom: 7px;">&nbsp;</label>
			<div>
				...
				<input type="submit" name="submit_password_recovery" class="button btn btn-primary" value="<?php esc_html_e( 'Reset password', 'wp-user-manager' ); ?>" />
			</div>
		</div>
	</div>
	</form>
