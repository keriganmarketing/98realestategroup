...
<div class="wpum-template wpum-form wpum-login-form">
	...
	<form action="<?php echo esc_url( $data->action ); ?>" method="post" id="wpum-submit-login-form" enctype="multipart/form-data">
			...
			<fieldset class="fieldset-<?php echo esc_attr( $key ); ?>">
				...
				<?php if( $field['type'] == 'checkbox' ) : ?>
					...
					<div class="custom-control custom-checkbox">
						...
						?>
						<label for="<?php echo esc_attr( $key ); ?>" class="custom-control-label"><?php echo esc_html( $field['label'] ); ?></label>
		...
		<input type="submit" name="submit_login" class="button btn btn-primary" value="<?php esc_html_e( 'Login', 'wp-user-manager' ); ?>" />		
	</form>
